  ...
  <body>
    ...
    <header class="header-section">
          ...
          if(isset($_SESSION['username'])){
            echo '<button type="button" class="btn btn-dark"><a class="text-white" href="cartkidclothes.php">Cart</a></button>', '<button type="button" class="btn btn-dark"><a class="text-white" href="account.php">My Account</a></button>', '<button type="button" 
...
-->
      ...
      <div class="small-12">
        <?php
          ...
          $result = $mysqli->query('SELECT * FROM kidclothes');
          if($result === FALSE){
            die(mysql_error());
          }
          ...
          if($result){
            ...
            while($obj = $result->fetch_object()) {
              ...
              if($obj->qty > 0){
                echo '<p><a href="update-cartkidclothes.php?action=add&id='.$obj->id.'"><input type="submit" value="Add To Cart" style="clear:both; background: #0078A0; border: none; color: #fff; font-size: 1em; padding: 10px;" /></a></p>';
                echo '<br>';
