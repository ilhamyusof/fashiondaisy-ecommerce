      ...
      <div class="large-12">
        <?php
          ...
          if(isset($_SESSION['cart'])) {
            ...
            $result = $mysqli->query("SELECT product_code, product_name, product_desc, qty, price FROM kidbags WHERE id = ".$product_id);
            ...
            if($result){
              ...
              while($obj = $result->fetch_object()) {
                ...
                echo '<td>&nbsp;<a class="btn btn-outline-success waves-effect" style="padding:5px;" href="update-cartkidbags.php?action=add&id='.$product_id.'">+</a>'.$quantity.'&nbsp;<a class="btn btn-outline-danger waves-effect" style="padding:5px;" href="update-cartkidbags.php?action=remove&id='.$product_id.'">-</a></td>';
                echo '<td>'.$rm.$cost.'</td>';
                echo '</tr>';
              }
            }
          ...
          echo '<tr>';
          echo '<td colspan="4" align="right"><a href="update-cartkidbags.php?action=empty" class="btn btn-dark">Empty Cart</a>&nbsp;<a href="index.php" class="btn btn-dark">Continue Shopping</a>';
          if(isset($_SESSION['username'])) {
            echo '<a href="orders-updatekidbags.php"><button class="btn btn-success btn-rounded" style="float:right;">Checkout</button></a>';
          }
